...
const (
	AssignmentService_GetAssignment_FullMethodName = "/helpdesk.assignment.v1.AssignmentService/GetAssignment"
)
...
//
// AssignmentService exposes assignment lookup (auto-assign runs via NATS).
...
var AssignmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "helpdesk.assignment.v1.AssignmentService",
	...
	Metadata: "helpdesk/assignment/v1/assignment.proto",
}
